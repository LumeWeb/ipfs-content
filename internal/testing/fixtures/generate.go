...
//go:generate go run ./cmd/invalid-car-generator/main.go
//go:generate go run ./cmd/empty-car-generator/main.go
//go:generate go run ./cmd/protobuf-generator/main.go
