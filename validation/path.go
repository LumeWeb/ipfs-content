...
// This is a shared validation function used by all archive extractors to prevent zip-slip attacks.
//
// Example:
//
//	err := validation.ValidateArchivePath("relative/path/to/file.txt")
//	if err != nil {
//	    // handle error
//	}
